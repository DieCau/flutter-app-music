...
class RecentListHomeEntity extends Equatable {
  ...
  factory RecentListHomeEntity.fromJson(Map<String, dynamic> json) => RecentListHomeEntity(
        id: json['id'],
        title: json['title'],
  ...
  factory RecentListHomeEntity.fromModelDb(PlayListModelDb db) => RecentListHomeEntity(
        id: db.id,
        title: db.title,

import 'package:music_app/features/home/data/network/model/playlist_model/creator_model_db.dart';
import 'package:music_app/features/home/data/network/model/playlist_model/track_model_db.dart';
...
class PlayListModelDb {
  ...
  factory PlayListModelDb.fromJson(Map<String, dynamic> json) => PlayListModelDb(
        id: json["id"],
        ...
        pictureSmall: json["picture_small"] ?? "no-picture-small",
        pictureMedium: json["picture_medium"] ?? "no-picture-mediun",
        pictureBig: json["picture_big"] ?? "no-picture-big",
        pictureXl: json["picture_xl"] ?? "no-picture-xl",
        checksum: json["checksum"] ?? "no-cecksun",
        tracklist: json["tracklist"] ?? "no-picture-tracklist",
        creationDate: DateTime.parse(json["creation_date"]),
        md5Image: json["md5_image"] ?? "no-md5",
        pictureType: json["picture_type"] ?? "no-picture-type",

...
class SearchBloc extends Bloc<SearchEvent, SearchState> {
  ...
  SearchBloc({required this.searchMusicRepository}) : super(SearchState.intial()) {
    on<SearchMusicEvent>(searchMusicEvent);
    on<ResetEvent>(resetEvent);
  }

  Future<void> searchMusicEvent(SearchMusicEvent event, Emitter<SearchState> emit) async {

...
class FavoriteMusicBloc extends Bloc<FavoriteMusicEvent, FavoriteMusicState> {
  ...
  FavoriteMusicBloc({required this.favoriteMusicRepository}) : super(FavoriteMusicState.intial()) {
  ...
  Future<void> fetchAllFavoriteMusicEvent(
      FetchAllFavoriteMusicEvent event, Emitter<FavoriteMusicState> emit) async {

...
class ArtistDbResponseModel {
  ...
  factory ArtistDbResponseModel.fromJson(Map<String, dynamic> json) => ArtistDbResponseModel(
        trackDb: List<ArtisTrackDb>.from(json["data"].map((x) => ArtisTrackDb.fromJson(x))),
        total: json["total"] ?? 0,
        next: json["next"] ?? "",
      );
